...
top_selected_final <- readRDS("feature_eIF3a_Full.rds") # you have to save it !
ROC_max <- readRDS("ROC_max_eIF3a_Full.rds") 
...
FulleIF3a_StoreMatrix <- readRDS("/home/yuxuan.wu/m6A reader/storeMatrix/FulleIF3a_StoreMatrix_mix.rds")
...
method <- c("genome_chemiPro")
    ...
    rest_seq <- as.character(DNAStringSet(Views(Hsapiens,rest_genome+20)))
...
saveRDS(finalResults,"/home/yuxuan.wu/m6A reader/vennPlot/FulleIF3a_mixup.rds")
