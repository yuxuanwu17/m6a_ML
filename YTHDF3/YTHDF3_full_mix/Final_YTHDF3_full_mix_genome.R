# library(doParallel)
# registerDoParallel(makePSOCKcluster(15))
...
index_train <- grep(1,FullYTHDF3_Pos$GSE73405)
FullYTHDF3_Pos_indep <- FullYTHDF3_Pos[index_train]

# testing_sample
index_testing <- grep(1,FullYTHDF3_Pos$GSE65004)
...
saveRDS(FullYTHDF3_StoreMatrix,"Final_FullYTHDF3_StoreMatrix.rds")
