...
p_index <- grep(1,FullYTHDF3_p$GSE78030)
...
ggsave("auroc_Full_YTHDF378030.pdf",VarMresult)
...
saveRDS(FullYTHDF3_StoreMatrix,"FullYTHDF3_StoreMatrix_genome_78030.rds")
