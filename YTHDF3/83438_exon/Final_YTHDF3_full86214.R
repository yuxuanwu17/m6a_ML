...
for (method in tst_all){
  ...
  setwd("~/testing")
  aucName <- paste("aucMatrix",method,"-tstallFull86214.rds",sep = "")  
...
saveRDS(FullYTHDF3_StoreMatrix,"storeMatrix_FullYTHDF3_tstall86214.rds")
...
index_train <- grep(1,FullYTHDF3_Pos$GSE86214)
FullYTHDF3_Pos_indep <- FullYTHDF3_Pos[index_train]

# testing_sample
index_testing <- grep(1,FullYTHDF3_Pos$GSE86214)
...
rownames(FullYTHDF3_StoreMatrix) <- c("genome_chemiPro","CONPOSITION","Chemiprop_SeqFeature","EIIP","AutoCo_PseKNC","AutoCo","PSNP","genome","onehot")
colnames(FullYTHDF3_StoreMatrix) <- c("crossValid","indepTest")
FullYTHDF3_StoreMatrix <-  readRDS("/home/yuxuan.wu/m6A reader/storeMatrix/storeMatrix_FullYTHDF3_tstall86214.rds")
...
setwd("/home/yuxuan.wu/m6A reader/storeMatrix")
saveRDS(FullYTHDF3_StoreMatrix,"Final_FullYTHDF3_StoreMatrix86214.rds")
