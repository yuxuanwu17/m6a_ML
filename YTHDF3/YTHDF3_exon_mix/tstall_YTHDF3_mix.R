...
for (method in "CONPOSITION"){
  ...
  setwd("~/testing/YTHDF3_mix")
  aucName <- paste("aucMatrix",method,"-tstall_mix_YTHDF3.rds",sep = "")  
...
# saveRDS(ExonYTHDF3_StoreMatrix,"storeMatrix_Exon_YTHDF3_mix.rds")
