...
FullYTHDF3_StoreMatrix <- readRDS("/home/yuxuan.wu/m6A reader/storeMatrix/storeMatrix_Full_YTHDF3_mix.rds")
...
saveRDS(FullYTHDF3_StoreMatrix,"Final_FullYTHDF3_StoreMatrix_mixup.rds")
