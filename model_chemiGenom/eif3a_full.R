...
FulleIF3a_StoreMatrix <-  readRDS("/home/yuxuan.wu/m6A reader/storeMatrix/eIF3a/storeMatrix_FulleIF3a.rds")
...
for (method in genome_method){
    ...
    if (method=="genome_chemiPro"){
      ...
      try(pred_result_auc2 <- performance(pred_result2,"auc"))
      try(aucMatrix[i,] <-attr(pred_result_auc2,"y.values")[[1]][1])
      saveRDS(reModel2,"/home/yuxuan.wu/m6A reader/model/eIF3a_Full.rds")
    }
...
# saveRDS(FulleIF3a_StoreMatrix,"Final_FulleIF3a_StoreMatrix.rds")
