...
GenoFgenreation <- function(data){
  Notmethylated_sample <- readRDS("/home/kunqi/m6A reader/YTHDF3/Exon/negative1.rds")
  mature_sample <- readRDS("/home/kunqi/m6A reader/YTHDF3/Exon/postive.rds")
  analysis_data <- data
  ...
  top_selected_final <- readRDS("/home/yuxuan.wu/m6A reader/top_selected_final/feature_YTHDF3_Exon.rds")
...
SitePredictionCollection <- function(data){
  ...
  reModel2 <- readRDS("/home/yuxuan.wu/m6A reader/model/YTHDF3_Exon78030.rds")
