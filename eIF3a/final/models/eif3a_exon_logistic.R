...
ExoneIF3a_resultsMatx <- matrix(NA, nrow = 1, ncol = 5)
colnames(ExoneIF3a_resultsMatx)<- c("crossValid","indepTest","avgPRAUC","avgACC","avgMatt")
ExoneIF3a_resultsMatx[1,] <- results
saveRDS(ExoneIF3a_resultsMatx,"/home/yuxuan.wu/m6A reader/5values/ExoneIF3a_mixup_logistic.rds")
