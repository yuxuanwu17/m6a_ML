...
FullYTHDF3_StoreMatrix <- readRDS("/home/yuxuan.wu/m6A reader/storeMatrix/FullYTHDF3_StoreMatrix_mix.rds")
...
FullYTHDF3_resultsMatx <- matrix(NA, nrow = 1, ncol = 5)
colnames(FullYTHDF3_resultsMatx)<- c("crossValid","indepTest","avgPRAUC","avgACC","avgMatt")
FullYTHDF3_resultsMatx[1,] <- results
saveRDS(FullYTHDF3_resultsMatx,"/home/yuxuan.wu/m6A reader/5values/FullYTHDF3_mixup_logistic.rds")
