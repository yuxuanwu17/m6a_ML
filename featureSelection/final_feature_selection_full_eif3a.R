...
Varplot
ggsave("/home/yuxuan.wu/m6A reader/auroc/AUROC_nomal_f_score_YTHDF3_Full.pdf",Varplot,width = 8.63, height = 4.7)
...
saveRDS(ROC_max,"ROC_max_YTHDF3_Full.rds")
...
ggsave("auroc_Full_YTHDF3_mix.pdf",VarMresult,width = 8.63, height = 4.7)
