...
mcols(ExoneIF3a_p) <- NULL
rowRanges(matureSE) <- c(ExoneIF3a_p,read_neg-2) # -2!
...
label_train <- c(rep("P",(length(ExoneIF3a_p))),rep("N",(length(read_neg))))
...
Varplot
ggsave("/home/yuxuan.wu/m6A reader/auroc/AUROC_nomal_f_score_eif3a_exon.pdf",Varplot,width = 8.63, height = 4.7)
...
saveRDS(ROC_max,"ROC_max_eIF3a_Exon.rds")
...
ggsave("auroc_Exon_eIF3a_mix.pdf",VarMresult,width = 8.63, height = 4.7)
