...
mcols(ExonYTHDF3_p) <- NULL
rowRanges(matureSE) <- c(ExonYTHDF3_p,read_neg-2) # -2!
...
label_train <- c(rep("P",(length(ExonYTHDF3_p))),rep("N",(length(read_neg))))
...
Varplot
ggsave("/home/yuxuan.wu/m6A reader/auroc/AUROC_nomal_f_score_YTHDF3_Exon.pdf",Varplot,width = 8.63, height = 4.7)
...
saveRDS(ROC_max,"ROC_max_YTHDF3_Exon.rds")
...
ggsave("auroc_Exon_YTHDF3_mix.pdf",VarMresult,width = 8.63, height = 4.7)
